...
<div class="pointer-events-none fixed right-0 bottom-0 left-0 flex items-end justify-between">
	<div class="pointer-events-auto grid w-full grid-cols-8 grid-rows-2 gap-0.5">
		...
		{#each links as { name, href, icon }}
			<a
				...
				class={[
					'corner pointer-events-auto col-span-2 flex flex-col items-center justify-center gap-1 px-2x pb-1.5 text-xs font-medium',
